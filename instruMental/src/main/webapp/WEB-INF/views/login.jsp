...
<body>
	...
	<form:form action="./logginprocess" method="POST">
		...
		<div class="sm-3">
			<label for="prueba">Nombre de usuario:</label> <input type="text"
				placeholder="escriba su nombre" required> <span
				class="resultado"></span>
		</div>
		<div class="sm-3">
		...
		<c:if test="${param.logout != null}">
			<div>
				<p class="logout">Sesión de usuario cerrada</p>
			</div>
		</c:if>
